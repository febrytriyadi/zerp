<nav class="w-64 bg-white border-r border-gray-200 min-h-screen overflow-y-auto">
    <div class="p-4">
    ...
    <ul class="space-y-1 px-2">
        <li>
            <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-2 rounded-md text-sm {{ request()->is('dashboard') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
        ...
        <li x-data="{ open: {{ request()->is('master/*') ? 'true' : 'false' }} }">
            ...
            <ul x-show="open" class="mt-1 ml-4 space-y-1">
                ...
                <li><a href="#" class="block px-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-100">Branches</a></li>
        ...
        <li x-data="{ open: {{ request()->is('reports/*') ? 'true' : 'false' }} }">
            ...
            <ul x-show="open" class="mt-1 ml-4 space-y-1">
                ...
                <li><a href="#" class="block px-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-100">Balance Sheet</a></li>
                <li><a href="#" class="block px-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-100">Income Statement</a></li>
            </ul>
        </li>
    </ul>
</nav>