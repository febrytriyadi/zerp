    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-900">Create Faktur Pajak</h2>
            </div>
            <form action="{{ route('finance.tax-invoices.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="tax_invoice_number" value="{{ old('tax_invoice_number') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tax_invoice_date" value="{{ old('tax_invoice_date', date('Y-m-d')) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <select name="transaction_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                            ...
                            <option value="retur_penjualan" {{ old('transaction_type') == 'retur_penjualan' ? 'selected' : '' }}>Retur Penjualan</option>
                            <option value="retur_pembelian" {{ old('transaction_type') == 'retur_pembelian' ? 'selected' : '' }}>Retur Pembelian</option>
                            <option value="lainnya" {{ old('transaction_type') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="taxpayer_name" value="{{ old('taxpayer_name') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="taxpayer_npwp" value="{{ old('taxpayer_npwp') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="taxpayer_address" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('taxpayer_address') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="dpp" value="{{ old('dpp', 0) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="ppn_amount" value="{{ old('ppn_amount', 0) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="ppnbm_amount" value="{{ old('ppnbm_amount', 0) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
