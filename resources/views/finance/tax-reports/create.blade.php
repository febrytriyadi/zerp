    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-900">Create Laporan Pajak</h2>
            </div>
            <form action="{{ route('finance.tax-reports.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="report_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                            ...
                            <option value="ppn_1111" {{ old('report_type') == 'ppn_1111' ? 'selected' : '' }}>SPT Masa PPN 1111</option>
                            <option value="pph_23" {{ old('report_type') == 'pph_23' ? 'selected' : '' }}>SPT Masa PPh 23</option>
                            <option value="pph_42" {{ old('report_type') == 'pph_42' ? 'selected' : '' }}>SPT Masa PPh 4(2)</option>
                            <option value="pph_21" {{ old('report_type') == 'pph_21' ? 'selected' : '' }}>SPT Masa PPh 21</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="period_code" value="{{ old('period_code') }}" placeholder="e.g. 2026-01" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="period_start" value="{{ old('period_start') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="period_end" value="{{ old('period_end') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
