            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-lg shadow">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        <h2 class="text-lg font-medium text-gray-900">Quotation Detail</h2>
                        <span class="text-sm text-gray-500">#{{ $quotation->quotation_number }}</span>
                    </div>
                    <div class="p-6">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <dt class="text-xs font-medium text-gray-500 uppercase">Quotation Number</dt>
                                <dd class="mt-1 text-sm text-gray-900">{{ $quotation->quotation_number }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs font-medium text-gray-500 uppercase">Quotation Date</dt>
                                <dd class="mt-1 text-sm text-gray-900">{{ $quotation->quotation_date }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs font-medium text-gray-500 uppercase">Customer</dt>
                                <dd class="mt-1 text-sm text-gray-900">{{ $quotation->customer->name ?? $quotation->customer_id }}</dd>
                            </div>
                            <div>
                                <dt class="text-xs font-medium text-gray-500 uppercase">Valid Until</dt>
                                <dd class="mt-1 text-sm text-gray-900">{{ $quotation->valid_until ?? '-' }}</dd>
                            </div>
                            <div>
                        ...
                        <div class="mt-4 p-4 bg-gray-50 rounded-md">
                            ...
                            <p class="text-sm text-gray-600">{{ $quotation->customer->name }}</p>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="px-3 py-2 text-sm font-medium text-gray-900 text-right">{{ number_format($quotation->total, 0, ',', '.') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 space-y-3">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium">Rp {{ number_format($quotation->total, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow">
